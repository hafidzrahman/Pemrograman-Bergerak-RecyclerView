...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listMhs.add(new appDesign(R.drawable.dafuq, "Daffa Ikhwan N", "12250110979"));
        listMhs.add(new appDesign(R.drawable.jelita, "Dwi Jelita A", "12250120331"));
        ...
        listMhs.add(new appDesign(R.drawable.rafly, "M. Rafly W", "12250111489"));
        listMhs.add(new appDesign(R.drawable.nurika, "Nurika Dwi W", "12250120360"));
        listMhs.add(new appDesign(R.drawable.ogi, "Ogya Secio N. S", "12250111346"));
        listMhs.add(new appDesign(R.drawable.rahma, "Rahma Laksita", "12250124357"));
        listMhs.add(new appDesign(R.drawable.srya, "Surya H Firdaus", "12250111759"));
